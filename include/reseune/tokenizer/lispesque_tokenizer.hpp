...
#define TOKENIZER_SPAN_T tokenizer_span_with_children
#else
#define TOKENIZER_SPAN_T tokenizer_span
#endif
...
namespace reseune {  
  ...
  // ===================================================================================================================
  struct lispesque_tokenizer : public tokenizer<TOKENIZER_SPAN_T, lispesque_token_type> {
  ...
  protected:
    ...
    // Types
    // =================================================================================================================
    using base_t = tokenizer<TOKENIZER_SPAN_T, lispesque_token_type>;

#undef TOKENIZER_SPAN_T
